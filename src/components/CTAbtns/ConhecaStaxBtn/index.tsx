...
const ConhecaStaxBtn = () => {
  return (
    <button
      ...
      className="cursor-pointer bg-gradient-stax h-11 rounded-3xl p-2 md:px-8 flex items-center justify-center mr-auto gap-2 hover:px-16 hover:bg-gradient-stax-2 transition-all"
    >
